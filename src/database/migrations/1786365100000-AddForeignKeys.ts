...
const FOREIGN_KEYS: Fk[] = [
  ...
  },
  {
    ...
    column: 'driverVerificationId',
    refTable: 'driver_verifications',
    onDelete: 'CASCADE',
  },
  {
  ...
  {
    table: 'bookings',
    column: 'riderRequestId',
    refTable: 'rider_requests',
    onDelete: 'CASCADE',
  },
];
